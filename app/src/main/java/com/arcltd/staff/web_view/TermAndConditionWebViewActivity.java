...
public class TermAndConditionWebViewActivity extends AppCompatActivity implements View.OnClickListener {
    WebView webView;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://onlineformsolution.in/arcMessApi/arcTermConditions.php";
    ...
    private void setListeners() {
        back.setOnClickListener(TermAndConditionWebViewActivity.this);
        forward.setOnClickListener(TermAndConditionWebViewActivity.this);
        refresh.setOnClickListener(TermAndConditionWebViewActivity.this);
        close.setOnClickListener(TermAndConditionWebViewActivity.this);
    }
    ...
    private void LoadWebViewUrl(String url) {
        if (isInternetConnected())
            ...
            refresh.setVisibility(View.VISIBLE);
            Toast.makeText(TermAndConditionWebViewActivity.this, "Oops!! There is no internet connection. Please enable your internet connection.", Toast.LENGTH_LONG).show();
