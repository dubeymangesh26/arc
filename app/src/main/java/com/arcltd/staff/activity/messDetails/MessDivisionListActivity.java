...
import com.arcltd.staff.adapter.MessDivisionListAdapter;
...
public class MessDivisionListActivity extends BaseActivity {

    RecyclerView list;
    SwipeRefreshLayout swiptoRefresh;
    private MessDivisionListAdapter.RerfreshWishList activeRerfreshWishList;
    String data;
            ...
            try {
                ...
                if (divisionListResponse != null) {
                    if (divisionListResponse.getDivision_list()!=null) {
                        ...
                        MessDivisionListAdapter listAdapter = new MessDivisionListAdapter(this, divisionListResponse.getDivision_list()
