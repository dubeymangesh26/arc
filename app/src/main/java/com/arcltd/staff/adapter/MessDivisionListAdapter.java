...
import com.arcltd.staff.activity.messDetails.MessListActivity;
...
public class MessDivisionListAdapter extends RecyclerView.Adapter<MessDivisionListAdapter.ViewHolder> {
    Context context;
    ...
    public MessDivisionListAdapter(FragmentActivity activity, List<DivisionListResponse.DivisionList>
    ...
    public void onBindViewHolder(ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.listRegion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("TAG", "MessListActivity: "+data );
                context.startActivity(new Intent(context, MessListActivity.class)
                        .putExtra("div_name", list.get(position).getDivision_name()));
