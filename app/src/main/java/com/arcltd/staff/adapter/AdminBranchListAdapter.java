...
public class AdminBranchListAdapter extends RecyclerView.Adapter<AdminBranchListAdapter.ViewHolder> {
    Context context;
    ...
    public AdminBranchListAdapter(Context context, List<BranchListResponse.BranchList>
