...
public class RetireEmployeeListAdapter extends RecyclerView.Adapter<RetireEmployeeListAdapter.ViewHolder> {
    Context context;
    ...
    public RetireEmployeeListAdapter(FragmentActivity activity, List<EmployeeListResponse.EmployeeList>
