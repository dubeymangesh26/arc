...
public class AdministrativEXPAdminResponse {

    private List<BranchAdministrativeexpList> branch_administrativeexp_list;
    @SerializedName("ResponseCode")
    private String responseCode;
    private String message;

    public List<BranchAdministrativeexpList> getBranch_administrativeexp_list() {
        return branch_administrativeexp_list;
    }

    public void setBranch_administrativeexp_list(List<BranchAdministrativeexpList> branch_administrativeexp_list) {
        this.branch_administrativeexp_list = branch_administrativeexp_list;
    }
    ...
    public static class BranchAdministrativeexpList {
