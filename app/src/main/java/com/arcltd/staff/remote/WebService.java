package com.arcltd.staff.remote;
...
public interface WebService {
   ...
   /* @Multipart
    ...
    Single<RegisterRespponse> signup(
            ...
            @Part("contactno") String contactno,
            @Part("login_type") String login_type,
            @Part("region_id") String region_id,
            @Part("region_name") String region_name,
            @Part("division_id") String division_id,
            @Part("division_name") String division_name,
            @Part("branch_code") String branch_code,
            @Part("branch_name") String branch_name,
            @Part("emp_code") String emp_code,
            @Part("design") String design,
            @Part("status") String status,
            @Part("mess_name") String mess_name,
            @Part("vari_status") String vari_status,
            @Part MultipartBody.Part upload);*/

    @Multipart
    @POST("user_registration.php")
    Call<RegisterRespponse> signup(
            ...
            @Part("region_name") RequestBody region_name,
            @Part("division_id") RequestBody division_id,
            @Part("division_name") RequestBody division_name,
            ...
            @Part("mess_name") RequestBody mess_name,
            @Part("vari_status") RequestBody vari_status,
    ...
    @FormUrlEncoded
    @POST("daily_booking_list.php")
    Single<BookingListResponse> list_booking
            (@Field(value = "branch_code", encoded = true) String branch_code,
            @Field(value = "division_id", encoded = true) String division_id
            );

    @FormUrlEncoded
    @POST("holiday_list.php")
    Single<HolidaysResponse> list_festHolidays
            (@Field(value = "year", encoded = true) String year);

    @FormUrlEncoded
    @POST("pdf_allList.php")
    Single<PDFListResponse> list_pdflst
            (@Field(value = "year", encoded = true) String year);
    ...
    @FormUrlEncoded
    @POST("ratecard_list.php")
    Single<RateCardListResponse> list_card(
            @Field(value = "branch_code", encoded = true) String branch_code,
            @Field(value = "search", encoded = true) String search);
    ...
    @FormUrlEncoded
    @POST("consignmentTracking.php")
    Single<ConsignmentTrackListResponse>
    cnsTrack(@Field(value = "cns_no", encoded = true) String cns_no);

    @FormUrlEncoded
    @POST("ConsignmentMovement.php")
    Single<ConsignmentMovementListResponse>
    cnsMovement(@Field(value = "cns_no", encoded = true) String cns_no);
